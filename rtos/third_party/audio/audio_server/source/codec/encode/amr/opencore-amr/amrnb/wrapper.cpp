...
#ifdef AMRNB_TINY
struct encoder_state g_encoder_state;
#endif /* AMRNB_TINY */

void* Encoder_Interface_init(int dtx) {
#ifdef AMRNB_TINY
	struct encoder_state* state = &g_encoder_state;
#else
	struct encoder_state* state = (struct encoder_state *)oscl_malloc(sizeof(struct encoder_state));
#endif /* AMRNB_TINY */
