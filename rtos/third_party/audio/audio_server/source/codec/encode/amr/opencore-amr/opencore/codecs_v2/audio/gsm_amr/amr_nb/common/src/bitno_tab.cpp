...
#ifdef AMRNB_TINY
const Word16 bitno_MR475[1] = {0};
const Word16 bitno_MR515[1] = {0};
const Word16 bitno_MR59[1] = {0};
const Word16 bitno_MR67[1] = {0};
const Word16 bitno_MR74[1] = {0};
const Word16 bitno_MR795[1] = {0};
const Word16 bitno_MR102[1] = {0};
const Word16 bitno_MRDTX[1] = {0};
#endif /* AMRNB_TINY */
