...
SAMPLETYPE *FIFOSampleBuffer_ptrEnd(FIFOSampleBuffer *pFSB,
...
/// the sample buffer.
void FIFOSampleBuffer_putSamples2(FIFOSampleBuffer *pFSB, const SAMPLETYPE *samples, ///< Pointer to samples.
...
/// careful though!
void FIFOSampleBuffer_putSamples(FIFOSampleBuffer *pFSB, uint numSamples ///< Number of samples been inserted.
                                );
...
uint FIFOSampleBuffer_receiveSamples2(FIFOSampleBuffer *pFSB, SAMPLETYPE *output, ///< Buffer where to copy output samples.
...
uint FIFOSampleBuffer_receiveSamples(FIFOSampleBuffer *pFSB, uint maxSamples ///< Remove this many samples from the beginning of pipe.
                                    );
