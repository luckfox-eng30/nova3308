 // THUMB
    ...
    .syntax unified
    .section AudioCode
    .global SubFilter_bass_Core_16

SubFilter_bass_Core_16:
// SubFilter_bass_Core(short *pwBuffer, unsigned short frameLen,int index,int L)
...
//;-----    ---------------
    ...
    MOV      r2,r0
    ASR      r2,#25
// 10+15 if process value >>(low 32) ,need process low 32bit(r0),not high 32bit
    CMP      r2,#0xFFFFFFFF
    BNE      peak1
...
peak2:
#        MOV      r0,#0x7FFF
        LDR      r0,=0x7FFF  // hjl:change mov to ldr instruction for gcc as.
