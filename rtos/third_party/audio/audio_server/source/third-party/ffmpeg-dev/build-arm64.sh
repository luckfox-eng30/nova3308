...
OPTIMIZE_CFLAGS="-fno-omit-frame-pointer"
...
FFMPEG_BUILD_FLAGS="ffmpeg open source projects(http://www.ffmpeg.org/), build for android-arm-64bit. ${COMMON_FF_CFG_FLAGS}"
